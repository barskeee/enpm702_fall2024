...
void university::Date::print_date() const { //namespace::classname::methodname
...
ushort university::Date::get_days_in_month(ushort month, ushort year) const {
    switch (month) {
        case 2:
